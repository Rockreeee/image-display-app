...
class VideoModeScreenSimple:
    ...
    def create_widgets(self):
        # メインウィンドウ作成
        self.root = tk.Tk()
        self.root.title("Video Display App (Simple)")
    ...
    def play_random_video(self):
        ...
        print(f"動画再生開始: {random_file} (FPS: {fps})")
    ...
    def update_display(self):
        ...
        if hasattr(self, 'frame_interval'):
            update_interval = int(self.frame_interval * 1000)  # ミリ秒に変換
        else:
            update_interval = 33  # 約30FPS
    ...
    def display_frame(self, frame):
        ...
        if self.image_brightness < 1.0:
            ...
            pil_image = enhancer.enhance(self.image_brightness)
